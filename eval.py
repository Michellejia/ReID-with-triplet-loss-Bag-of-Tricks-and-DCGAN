...
def parse_args():
    ...
    parse.add_argument(
            ...
            dest = 'gallery_embs',
            type = str,
            default = 'E:\\graduation thesis\\code modification\\triplet-reid-pytorch-master-BagofTricks(BNNeck + CenterLoss)\\res\\emb_gallery.pkl',
    ...
    parse.add_argument(
            ...
            dest = 'query_embs',
            type = str,
            default = 'E:\\graduation thesis\\code modification\\triplet-reid-pytorch-master-BagofTricks(BNNeck + CenterLoss)\\res\\emb_query.pkl',
